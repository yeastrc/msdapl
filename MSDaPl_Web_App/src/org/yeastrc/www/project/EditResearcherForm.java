 ...
 * @version 2004-02-17
 */
public class EditResearcherForm extends ActionForm {
	...
	/** Get whether or not to send email to this researcher */
	...
	/** Whether or not to send email to this new researcher */
	public void setSendEmail(boolean arg) { this.sendEmail = arg; }
