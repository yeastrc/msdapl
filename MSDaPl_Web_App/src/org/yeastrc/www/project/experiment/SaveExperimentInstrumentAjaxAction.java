/**
 * SaveExperimentInstrumentAjaxAction.java
 ...
 * 
 */
public class SaveExperimentInstrumentAjaxAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        int instrumentId = 0;
        try {instrumentId = Integer.parseInt(request.getParameter("instrumentId"));}
        catch(NumberFormatException e) {;}
        
        if(instrumentId == 0) {
            response.setContentType("text/html");
            response.getWriter().write("<b>Invalid instrumentID: "+instrumentId+".</b>");
            return null;
        }
        ...
        try {
            ...
            expt.setInstrumentId(instrumentId);
            exptDao.update(expt);
        }
        catch(Exception e) {
            response.setContentType("text/html");
