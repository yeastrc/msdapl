/**
 * PercolatorFilteredResults.java
 ...
 * 
 */
public class PercolatorFilteredPsmResult {
	...
	private List<PercolatorBinnedPsmResult> binnedResults;
	...
	public List<PercolatorBinnedPsmResult> getBinnedResults() {
		return binnedResults;
	}
	public void setBinnedResults(List<PercolatorBinnedPsmResult> binnedResults) {
